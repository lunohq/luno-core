...
var updateTopicName = exports.updateTopicName = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(_ref3) {
    ...
    var _require, getRepliesForTopic, _ref4, _ref5, replies, indices, actions, _iteratorNormalCompletion3, _didIteratorError3, _iteratorError3, _iterator3, _step3, reply, _iteratorNormalCompletion4, _didIteratorError4, _iteratorError4, _iterator4, _step4, index, title;
    ...
    return _regenerator2.default.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 52:
            return _context3.abrupt('return', _clients.client.bulk({
              type: type,
              body: actions,
              routing: teamId
            }));
