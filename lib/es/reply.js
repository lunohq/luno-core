...
var indexReply = exports.indexReply = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref) {
    ...
    var rawTitle = _ref$reply.title;
    var keywords = _ref$reply.keywords;
    var body = (0, _objectWithoutProperties3.default)(_ref$reply, ['id', 'title', 'keywords']);
    var topics = _ref.topics;

    var title, displayTitle, prefix, suffix, indices, actions, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, index;
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 15:
            ...
            for (_iterator4 = (0, _getIterator3.default)(indices); !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              ...
              actions.push({ doc: { title: title, displayTitle: displayTitle } });
            }
            _context3.next = 28;
            break;
