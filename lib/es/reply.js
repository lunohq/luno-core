...
exports.msearch = exports.deleteTopic = exports.updateTopicName = exports.deleteReply = exports.indexReply = undefined;
...
var indexReply = exports.indexReply = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(_ref2) {
    ...
    var _ref2$reply$attachmen = _ref2$reply.attachments;
    var attachments = _ref2$reply$attachmen === undefined ? [] : _ref2$reply$attachmen;
...
var msearch = exports.msearch = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(_ref11) {
    ...
    var meta, requestTimeout, rest, tier, tiers;
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            tier = function tier(minimumShouldMatch) {
              var main = getTieredQuery({ teamId: teamId, query: query, minimumShouldMatch: minimumShouldMatch });
              return (0, _extends3.default)({}, main, rest);
            };

            meta = (0, _extends3.default)({}, _getClient.config.read, {
              type: type
            });
            requestTimeout = options.requestTimeout;
            rest = (0, _objectWithoutProperties3.default)(options, ['requestTimeout']);
            tiers = [
            // tier 1
            meta, tier(TIER_1),
            // tier 2
            ...
            // tier 3
            meta, tier(TIER_3)];
            return _context5.abrupt('return', _clients.strictClient.msearch((0, _extends3.default)({ body: tiers, requestTimeout: requestTimeout }, rest)));
...
function getTieredQuery(_ref10) {
  var teamId = _ref10.teamId;
  var query = _ref10.query;
  var minimumShouldMatch = _ref10.minimumShouldMatch;
      ...
      filtered: {
        query: {
          multi_match: {
            query: query,
            type: 'cross_fields',
            fields: ['titleV2', 'body', 'keywords', 'topic'],
...
function explain(_ref12) {
  ...
  var tier = _ref12.tier;

  var minimumShouldMatch = void 0;
  switch (tier) {
    case 1:
  ...
  var body = getTieredQuery({ teamId: teamId, query: query, minimumShouldMatch: minimumShouldMatch });
