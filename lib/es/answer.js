...
function search(botId, query) {
  ...
  return new _promise2.default(function (resolve, reject) {
    client.search((0, _extends3.default)({}, _getClient.config.read, options, {
      type: type,
      body: body
    }), function (err, res) {
      if (err) return reject(err);
...
function explain(botId, query, answerId) {
  var body = getQuery(botId, query);
  return new _promise2.default(function (resolve, reject) {
    client.explain((0, _extends3.default)({}, _getClient.config.read, _getClient.config.explain, {
      type: type,
      body: body,
      id: answerId,
      routing: botId
...
function validate(botId, query) {
  var body = getQuery(botId, query);
  return new _promise2.default(function (resolve, reject) {
    client.indices.validateQuery((0, _extends3.default)({}, _getClient.config.read, _getClient.config.explain, {
      type: type,
      body: body,
      explain: true,
      routing: botId
...
function analyze(_ref2) {
  ...
  return new _promise2.default(function (resolve, reject) {
    client.indices.analyze((0, _extends3.default)({}, _getClient.config.read, rest, {
      type: type,
      text: query
    }), function (err, res) {
      if (err) return reject(err);
