    ...
    return _regenerator2.default.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return (0, _getClient.getWriteIndices)(client);
          ...
          case 23:
            return _context.abrupt('return', client.bulk({
              type: type,
              body: actions,
              routing: body.botId
            }));
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 23:
            return _context2.abrupt('return', client.bulk({
              type: type,
              body: actions,
              routing: botId
            }));
...
function search(botId, query) {
  ...
  return strictClient.search((0, _extends3.default)({}, _getClient.config.read, options, {
    type: type,
    body: body
  }));
}
