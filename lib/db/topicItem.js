...
var removeItemFromTopics = exports.removeItemFromTopics = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(_ref4) {
    ...
    var params, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, topicId;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            for (_iterator = (0, _getIterator3.default)(topicIds); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              topicId = _step.value;
...
var table = (0, _client.resolveTableName)('topic-v1');
