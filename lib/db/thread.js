...
var commitThread = exports.commitThread = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(_ref7) {
    ...
    var params, generatedEvents, commit, index, event, generated, closePromise, promises, results;
...
function generateEvent(_ref2) {
  ...
  var data = (0, _objectWithoutProperties3.default)(_ref2, ['offset', 'threadId', 'botId', 'channelId', 'messageId', 'userId']);
