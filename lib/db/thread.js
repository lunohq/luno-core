...
var getThreadLogs = exports.getThreadLogs = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(_ref8) {
    var teamId = _ref8.teamId;
    var startKey = _ref8.startKey;
...
var getThreadLog = exports.getThreadLog = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(_ref9) {
      ...
      while (1) {
        switch (_context12.prev = _context12.next) {
          case 0:
            params = {
              TableName: threadLogTable,
              Key: { teamId: teamId, threadId: threadId }
            };
            _context12.next = 3;
            return _client2.default.get(params).promise();
          ...
          case 3:
            ...
            if (data.Item) {
              log = (0, _client.fromDB)(ThreadLog, data.Item);
            }
            return _context12.abrupt('return', log);
  ...
  return function getThreadLog(_x12) {
    return ref.apply(this, arguments);
  };
}();

var getThreadLogPaginationBounds = exports.getThreadLogPaginationBounds = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(teamId) {
    var params, promises, _ref10, _ref11, first, last;
      ...
      while (1) {
        switch (_context13.prev = _context13.next) {
          case 0:
            ...
            promises = [_client2.default.query((0, _extends3.default)({}, params, { ScanIndexForward: false, Limit: 1 })).promise(), _client2.default.query((0, _extends3.default)({}, params, { ScanIndexForward: true, Limit: 1 })).promise()];
            _context13.next = 4;
            return _promise2.default.all(promises);
          ...
          case 4:
            ...
            if (first && first.Items && first.Items.length) {
              first = (0, _client.fromDB)(ThreadLog, first.Items[0]);
            }
            if (last && last.Items && last.Items.length) {
              last = (0, _client.fromDB)(ThreadLog, last.Items[0]);
            }
            return _context13.abrupt('return', { first: first, last: last });
  ...
  return function getThreadLogPaginationBounds(_x13) {
    return ref.apply(this, arguments);
  };
}();
...
var EVENT_ESCALATED = exports.EVENT_ESCALATED = 13;
