...
exports.getTopicsForReply = exports.getReplies = exports.getRepliesForTopic = exports.updateReply = exports.getReply = exports.deleteReply = exports.createReply = exports.Reply = exports.table = undefined;
...
var updateReply = exports.updateReply = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(_ref8) {
    ...
    var body = _ref8.body;
    var rawKeywords = _ref8.keywords;
    var updatedBy = _ref8.updatedBy;
    var _ref8$attachments = _ref8.attachments;
    var attachments = _ref8$attachments === undefined ? [] : _ref8$attachments;
    ...
    var keywords, params, mutex, topicIds, removeFrom, addTo, existingTopicIds, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, existingTopicId, data, previousReply, promises, res, reply, topics;

    return _regenerator2.default.wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            keywords = rawKeywords && rawKeywords.trim();
            params = {
              TableName: table,
              Key: { id: id, teamId: teamId },
              ConditionExpression: 'attribute_exists(#id)',
          ...
          case 77:
            _context7.prev = 77;
            _context7.t3 = _context7['catch'](72);
    ...
    }, _callee7, this, [[17, 21, 25, 33], [26,, 28, 32], [36, 42], [55, 61], [72, 77]]);
  }));
...
var getReplies = exports.getReplies = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee9(teamId) {
    var params, items;
      ...
      while (1) {
        switch (_context9.prev = _context9.next) {
          ...
          case 3:
            ...
            return _context9.abrupt('return', items.map(function (item) {
              return (0, _client.fromDB)(Reply, item);
            }));
  ...
  return function getReplies(_x9) {
    return ref.apply(this, arguments);
  };
}();

var getTopicsForReply = exports.getTopicsForReply = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee10(_ref12) {
    ...
    return _regenerator2.default.wrap(function _callee10$(_context10) {
      while (1) {
        switch (_context10.prev = _context10.next) {
          ...
          case 2:
            topicIds = _context10.sent;
            return _context10.abrupt('return', (0, _topic.getTopicsWithIds)({ teamId: teamId, topicIds: topicIds }));
  ...
  return function getTopicsForReply(_x10) {
    return ref.apply(this, arguments);
  };
}();
