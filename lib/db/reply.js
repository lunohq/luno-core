      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 11;
            return _promise2.default.all([(0, _topicItem.addItemToTopics)({ teamId: teamId, createdBy: createdBy, itemId: reply.id, topicIds: [topicId] }), _client2.default.put(params).promise(), (0, _topic.getTopicsWithIds)([topicId])]);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 29:
            ...
            _context3.next = 32;
            return _promise2.default.all([(0, _topicItem.removeItemFromTopics)({ teamId: teamId, itemId: id, topicIds: removeFrom }), (0, _topicItem.addItemToTopics)({ teamId: teamId, itemId: id, topicIds: addTo, createdBy: updatedBy }), _client2.default.update(params).promise(), (0, _topic.getTopicsWithIds)(topicIds.concat(addTo))]);
