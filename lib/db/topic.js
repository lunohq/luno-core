...
var createTopic = exports.createTopic = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee4(_ref4) {
    ...
    var data = (0, _objectWithoutProperties3.default)(_ref4, ['id', 'teamId', 'rollback']);
...
var updateTopic = exports.updateTopic = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(_ref5) {
    ...
    var results, previousTopic, params, data;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 8:
            ...
            _context5.prev = 10;
            _context5.next = 13;
            return _promise2.default.all([deleteTopicName({ teamId: teamId, name: previousTopic.name }), (0, _reply2.updateTopicName)({ teamId: teamId, name: name, topicId: id })]);
          ...
          case 21:
            return _context5.abrupt('return', (0, _client.fromDB)(Topic, data.Attributes));
