...
exports.getTopicsWithIds = exports.getDefaultTopic = exports.getTopic = exports.isValidName = exports.deleteTopic = exports.updateTopic = exports.createTopic = exports.Topic = exports.DUPLICATE_TOPIC_NAME_EXCEPTION = undefined;
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      _context3.next = 5;
                      return _promise2.default.all([_client2.default.batchDeleteAll({ table: _reply.table, keys: replyKeys }), _client2.default.batchDeleteAll({ table: _topicItem.table, keys: topicItemKeys })]);
...
var isValidName = exports.isValidName = function () {
  ...
  return function isValidName(_x4) {
    return ref.apply(this, arguments);
  };
}();
...
var getDefaultTopic = exports.getDefaultTopic = function () {
  ...
  return function getDefaultTopic(_x6) {
    return ref.apply(this, arguments);
  };
}();

var getTopicsWithIds = exports.getTopicsWithIds = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee8(_ref6) {
    var teamId = _ref6.teamId;
    var topicIds = _ref6.topicIds;
  ...
  return function getTopicsWithIds(_x7) {
    return ref.apply(this, arguments);
  };
}();
