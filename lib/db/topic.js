      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 10:
            ...
            _context5.prev = 12;
            _context5.next = 15;
            return _promise2.default.all([deleteTopicName({ teamId: teamId, name: previousTopic.name }), (0, _reply2.updateTopicName)({ teamId: teamId, name: displayName, topicId: id })]);
        ...
        switch (_context7.prev = _context7.next) {
          case 0:
            params = {
              ...
              Key: { teamId: teamId, name: name.toLowerCase() },
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            params = {
              TableName: topicNameTable,
              Item: { teamId: teamId, name: name.toLowerCase(), topicId: id },
