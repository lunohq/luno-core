      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            _context3.next = 12;
            return _promise2.default.all([deleteTopicName({ teamId: teamId, name: oldTopic.name }), (0, _reply2.updateTopicName)({ teamId: teamId, name: name, topicId: id })]);
        ...
        switch (_context4.prev = _context4.next) {
          ...
          case 12:
            ...
            if (topic) {
              ...
              promises.push((0, _reply2.deleteTopic)({ teamId: teamId, topicId: topicId }));
            }
