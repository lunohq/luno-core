...
exports.scan = exports.getAdmins = exports.getStaff = exports.getUsersWithIds = exports.getUsers = exports.updateUser = exports.getUser = exports.AnonymousUser = exports.User = exports.CONSUMER = exports.TRAINER = exports.ADMIN = exports.table = undefined;
...
var getUsersWithIds = exports.getUsersWithIds = function () {
  var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee5(ids) {
    return _regenerator2.default.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            return _context5.abrupt('return', _client2.default.batchGetAll({ table: table, items: ids, getKey: function getKey(id) {
                return { id: id };
              } }));
  ...
  return function getUsersWithIds(_x5) {
    return ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return _context8.abrupt('return', executeScan(params));
