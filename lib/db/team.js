...
exports.getTeams = exports.updateTeam = exports.getTeam = exports.Team = exports.TEMPLATE_ONBOARDING = exports.STATUS_INACTIVE = exports.STATUS_ACTIVE = undefined;
...
exports.ranTemplate = ranTemplate;
...
var STATUS_ACTIVE = exports.STATUS_ACTIVE = 0;
var STATUS_INACTIVE = exports.STATUS_INACTIVE = 1;

var TEMPLATE_ONBOARDING = exports.TEMPLATE_ONBOARDING = 'onboarding';
...
function updateTeamStatus(_ref3) {
  var id = _ref3.id;
...
function deactivateTeam(id) {
  return updateTeamStatus({ id: id, status: STATUS_INACTIVE });
}

function activateTeam(id) {
  return updateTeamStatus({ id: id, status: STATUS_ACTIVE });
}

function ranTemplate(_ref4) {
  var id = _ref4.id;
