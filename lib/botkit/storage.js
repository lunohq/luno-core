...
exports.default = {
  ...
  reactions: {
    ...
    shouldRespond: function shouldRespond(_ref4) {
      ...
      var _retrieveClient2 = retrieveClient();

      var client = _retrieveClient2.client;
  ...
  threads: {
    getOrOpen: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee6(_ref8) {
      ...
      return function getOrOpen(_x10) {
        return ref.apply(this, arguments);
      };
    }(),
    ...
    open: function () {
      var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee7(_ref10) {
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              ...
              case 2:
                ...
                return _context7.abrupt('return', { thread: thread, events: [] });
    ...
    receive: function receive(_ref12) {
      var source = _ref12.message;
      var thread = _ref12.thread;

      message = (0, _assign2.default)({}, source);
      delete message.luno;

      var _message = message;
      var messageId = _message.ts;
      var threadId = thread.id;
      var botId = thread.botId;
