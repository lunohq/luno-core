...
exports.default = {
  ...
  threads: {
            ...
            while (1) {
              switch (_context8.prev = _context8.next) {
                case 0:
                  ...
                  _context8.prev = 1;
                  _context8.next = 4;
                  return (0, _thread.lookupThread)({ botId: botId, channelId: channel, messageId: ts });
          ...
          return _regenerator2.default.wrap(function _callee9$(_context9) {
            while (1) {
              switch (_context9.prev = _context9.next) {
                ...
                case 11:
                  return _context9.abrupt('return', resolve(response));
    ...
    close: function close(_ref11) {
      var params = _ref11.thread;
      return new _promise2.default(function () {
          ...
          return _regenerator2.default.wrap(function _callee10$(_context10) {
            while (1) {
              switch (_context10.prev = _context10.next) {
                ...
                case 10:
                  return _context10.abrupt('return', resolve(thread));
    ...
    receive: function receive(_ref12) {
      ...
      return new _promise2.default(function () {
        var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee11(resolve, reject) {
          var _message, messageId, threadId, botId, channelId, userId, response;
            ...
            while (1) {
              switch (_context11.prev = _context11.next) {
                case 0:
                  ...
                  _context11.prev = 9;
                  _context11.next = 12;
                  return (0, _thread.createEvent)({ threadId: threadId, botId: botId, channelId: channelId, messageId: messageId, message: message, userId: userId });
    ...
    send: function send(_ref13) {
      ...
      return new _promise2.default(function () {
        var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee12(resolve, reject) {
          var threadId, botId, channelId, userId, messageId, response;
            ...
            while (1) {
              switch (_context12.prev = _context12.next) {
                case 0:
                  ...
                  _context12.prev = 7;
                  _context12.next = 10;
                  return (0, _thread.createEvent)({ threadId: threadId, botId: botId, channelId: channelId, message: message, messageId: messageId, userId: userId });
    ...
    log: function log(_ref14) {
      var thread = _ref14.thread;
      var event = _ref14.event;
      return new _promise2.default(function () {
        var ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee13(resolve, reject) {
          var threadId, botId, channelId, userId, response;
            ...
            while (1) {
              switch (_context13.prev = _context13.next) {
                case 0:
                  ...
                  _context13.prev = 5;
                  _context13.next = 8;
                  return (0, _thread.createEvent)((0, _extends3.default)({ threadId: threadId, botId: botId, channelId: channelId, userId: userId }, event));
                ...
                case 14:
                  return _context13.abrupt('return', resolve(response));
